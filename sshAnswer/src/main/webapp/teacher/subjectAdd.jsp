        ...
        <td valign="middle"><span class="left_txt">
			<div id="addSubjectForm" align="center"><!--录入试题表单-->
				...
				<table border="0" cellspacing="10" cellpadding="0">
				  ...
				  <tr>
					<td>选项A:</td>
					<td><input type="text" id="optionA" name="optionA" size="20" ></td>
				  </tr>
				   <tr>
					<td>选项B:</td>
					<td><input type="text" id="optionB" name="optionB" size="20" ></td>
				  </tr>
				   <tr>
					<td>选项C:</td>
					<td><input type="text" id="optionC" name="optionC" size="20" ></td>
				  </tr>
				   <tr>
					<td>选项D:</td>
					<td><input type="text" id="optionD" name="optionD" size="20" ></td>
				  </tr>
				   <tr>
					<td>答案:</td>
					<td>
